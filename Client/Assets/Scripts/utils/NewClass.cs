...
public static class CSVFileHelper
{
    ...
    public static Dictionary<int, Dictionary<string, string>> OpenCSV(string fileName)
    {
        Dictionary<int, Dictionary<string, string>> csvInfo = new Dictionary<int, Dictionary<string, string>>();
        //Encoding encoding = Common.GetType(fileName); //Encoding.ASCII;//
        ...
        //第二行是字段名
        strLine = sr.ReadLine();
        string[] columnName = strLine.Split(',');
        //标示列数
